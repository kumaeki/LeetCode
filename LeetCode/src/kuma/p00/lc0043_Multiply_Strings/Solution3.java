...
public class Solution3 {
    // Runtime: 16 ms, faster than 17.69% of Java online submissions for Multiply
    // Strings.
    // Memory Usage: 40.5 MB, less than 10.00% of Java online submissions for
    // Multiply Strings.
    ...
    @Test
    public void simple5() {
        assertEquals("3006", new Solution3().multiply("501", "6"));
    }

    @Test
    public void simple1() {
        assertEquals("6", new Solution3().multiply("2", "3"));
    }

    @Test
    public void simple2() {
        assertEquals("56088", new Solution3().multiply("123", "456"));
    }

    @Test
    public void simple3() {
        assertEquals("0", new Solution3().multiply("0", "1233"));
    }

    @Test
    public void simple4() {
        assertEquals("0", new Solution3().multiply("12345", "0"));
    }
}
